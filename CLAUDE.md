...
- `ruby/`, `runner`: tournament orchestration, and the benchmark (`ruby/checkpoint_benchmark.rb`, openings in `ruby/openings.rb`). `stats`, `ranking`: viewers. `multi`: rotates between several experiments.
