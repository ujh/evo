...
- **Test what the experiment depends on.** Add tests for Go rules (capture, ko, suicide, pass), mutation statistics, and the file format round trip.
...
1. Add characterization tests for crossover and mutation statistics and the file round trip.
